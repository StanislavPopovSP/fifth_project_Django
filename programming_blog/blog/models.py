...
class Blog(models.Model):
    ...
    cat = models.ForeignKey('Category', on_delete=models.PROTECT) # так как класс ниже, имя класса указываем в кавычках. Запрещается удалять записи из первичной модели, если она используется во вторичной, выдает исключение.
